...
Get-VMHost -Name "192.168.18.13" |Get-VM |  Select Name,MemoryGB,ProvisionedSpaceGB,UsedSpaceGB,NumCpu,@{N='Vm IP';E={$_.Guest.IPAddress[0]}}| Export-CSV C:\temp\vmsrv02report.csv -NoTypeInformation -Force

Get-VMHost -Name "192.168.18.13" |Get-VM | Get-Member